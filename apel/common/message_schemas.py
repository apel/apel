    ...
    "properties": {
        ...
        "UsageRecords": {
            ...
            "items": {
                ...
                #"allOf": [ # [ ] TODO Compile list of valid GPU + type combinations
                #    {
                #        "if": {
                #            "properties": {
                #                "Model": "GPU"
...
GPU_SUMMARY_MSG_SCHEMA = {
    "$schema": "http://json-schema.org/draft-07/schema", 
    "$id": "http://localhost/schema.json",
    "type": "object",
    "title": "GPU summary message schema root",
    "description": "This schema defines the basic conditions a GPU summary message must meet",
    "required": [
        "Type",
        "Version",
        "UsageRecords"
    ...
    "properties": {
        "Type": {
            ...
            "title": "JSON message type",
            "type": "string",
            "const": "APEL-GPU-summary-message"
        },
        "Version": {
            "$id": "#/properties/Version",
            "title": "JSON message version",
        ...
        "UsageRecords": {
            "$id": "#/properties/UsageRecords",
            "title": "GPU Summary usage records",
            "description": "The list of records matching GPU summary requirements",
            "type": "array",
            "minItems": 1,
            "maxItems": 1000,
            "items": {
